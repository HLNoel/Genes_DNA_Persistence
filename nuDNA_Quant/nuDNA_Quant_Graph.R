...
df <- read.csv("C:\\Users\\hanna\\Desktop\\nuDNA_thesis_exp\\nuclearDNA_thesis.csv")
...
plot(1, type="n", xlim=c(1,6),ylim=c(0,0.015), ylab="nuDNA Quantity (ng/ul)",las=1, cex.axis=0.8, cex.lab=0.8, xlab = "Week", main= "", mgp=c(3,0.5,0), col="white")
